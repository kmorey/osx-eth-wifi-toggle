...
eth_names=`networksetup -listnetworkserviceorder | sed -En 's|^\(Hardware Port: USB.*LAN, Device: (en.)\)$|\1|p'`
#eth_names=`networksetup -listnetworkserviceorder | sed -nE '/Ethernet|Dock/ s|.*Device: (en[0-9]+).*|\1|p'`
